...
//
//                if let node = scene.rootNode.childNode(withName: "Ship", recursively: true) {
...
//                    diceNode.runAction(SCNAction.rotateBy(x: CGFloat(randomX * 5), y: 0, z: CGFloat(randomZ * 5), duration: 0.5))
    ...
    /*
        // removeAllDice
     @IBAction dunc removeAlldice(_ sender: UIBarButtonItem
